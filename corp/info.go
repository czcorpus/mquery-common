...
// Attr is a general attribute in corpus. It can be either a positional
// attribute (word, lemma, tag,...) or a structural attribute (doc.pubyear, text.id,...).
type Attr struct {
...
type Overview struct {
	...
	AttrList       []Attr         `json:"attrList"`
	StructList     []Attr         `json:"structList"`
